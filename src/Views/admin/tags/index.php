<form id="tags-form" action="/admin/tags/process" method="POST">
    ...
    <div class="d-flex justify-content-center align-items-center gap-3 mt-3">
        ...
        <a href="/admin/tags/create" class="btn btn-primary">+ Создать тег</a>
    </div>
    ...
    <table class="table">
		...
		<?php foreach ($tags as $tag): ?>
            <tr class="tag-row <?php echo $tag->getIsActive() ? '' : 'inactive-tag'; ?>">
                ...
                <td>
                    <a href="/admin/tags/edit/<?php echo htmlspecialchars($tag->getId()); ?>" class="btn btn-sm btn-warning">Редактировать</a>
                </td>
            </tr>
		<?php endforeach; ?>
        </tbody>
